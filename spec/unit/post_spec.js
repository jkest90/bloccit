...
describe("Post", () => {
   ...
   describe("#create()", () => {
      ...
      it("should not create a post with a missing title, body, and assigned topic", (done) => {
   ...
   describe("#hasDownvoteFor", () => {
      ...
      it("should return true if user with matching userId has a downvote for a post", (done) => {
         Vote.create({
            value: -1,
            userId: this.user.id,
            postId: this.post.id
         ...
         .then((vote) => {
            this.vote = vote;
            this.post.hasDownvoteFor(this.vote.userId)
            .then((hasDownvote) => {
